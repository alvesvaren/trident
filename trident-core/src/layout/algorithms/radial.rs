...
//!
//! This layout uses a spanning tree approach where:
//! 1. The most connected node becomes the root
//! 2. A maximum spanning tree is built (keeping strongest connections)
//! 3. Nodes are placed in circular arcs around their parents
//!
//! This creates a "mind-map" style visualization.
...
use crate::layout::radial_placement::layout_nodes_radial;

/// Radial tree layout implementation.
pub struct RadialLayout;

impl LayoutStrategy for RadialLayout {
    fn layout(&self, diagram: &Diagram, cfg: &LayoutConfig) -> LayoutResult {
        layout_radial(diagram, cfg)
    }
}

/// Layout children of a group using radial placement.
fn layout_group_children_radial(
    diagram: &Diagram,
    gid: GroupId,
    cfg: &LayoutConfig,
    adjacency: &Adjacency,
    ...
    // 4. Place free nodes using radial layout
...
/// Internal implementation of the radial layout.
pub fn layout_radial(diagram: &Diagram, cfg: &LayoutConfig) -> LayoutResult {
